                            ...
                            >
                                <div className="relative">
                                    <img
                                        src={activeImage}
                                        alt="Preview"
                                        className="max-h-[90vh] max-w-[90vw] bg-white object-contain p-2 shadow-lg"
                                    />
                                </div>
                            </div>
                        )}
                        ...
                        {activeInsProf === 'campus-life' && (
                            <div>
                                ...
                                <p className="mx-auto mb-10 max-w-3xl text-lg leading-relaxed font-thin text-gray-700">
                                    ...
                                    inclusive campus environment that encourages
                                    academic growth, cultural appreciation, and
                                    student engagement. Our campus is a hub for
                                    innovation, creativity, and meaningful
                        ...
                        {activeInsProf === 'sports' && (
                            <div>
                                ...
                                <p className="mx-auto mb-10 max-w-3xl text-lg leading-relaxed font-thin text-gray-700">
                                    ...
                                    athletics and physical education. With
                                    competitive sports programs and recreational
                                    facilities, the university promotes
                                    teamwork, discipline, and well-being as part
                                    of every student’s journey.
                                </p>

                                {/* Add the useState hook at the top of your component */}
                                {/* const [selectedImage, setSelectedImage] = useState<string | null>(null); */}
